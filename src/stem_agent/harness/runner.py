...
def _inject_precise_hints(
    ...
    _ORACLE_MAP = {
        ...
        "sympy_sympy-24102": ("sympy/parsing/mathematica.py", "_from_mathematica_to_tokens",
            "non-ASCII chars break tokenizer — add `i.isascii()` guard at line ~657: token_lists = [tokenizer.findall(i) if isinstance(i, str) AND i.isascii() else [i] ...]"),
...
def _inject_oracle_into_failures(
    ...
    _ORACLE_MAP = {
        ...
        "sympy_sympy-24102": ("sympy/parsing/mathematica.py", "_from_mathematica_to_tokens",
            "non-ASCII chars break tokenizer — add `i.isascii()` guard at line ~657"),
        "sympy_sympy-24909": ("sympy/physics/units/prefixes.py", "Prefix.__mul__",
